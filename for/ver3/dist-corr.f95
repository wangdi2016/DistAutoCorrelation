...
! Output file format
      ...
      INTEGER, PARAMETER :: N = 5000 ! 50000 lines used to allocate memory for file1
      INTEGER, PARAMETER :: M = 5000 ! 50000 lines used to allocate memory for file2
      INTEGER, PARAMETER :: L = 1200 ! max output lines
